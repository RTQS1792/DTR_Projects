...
class irGetCMD(object):
    ...
    def __logHandler(self, source):
        ...
        if self.start == 0:
            ...
            return
        self.logList.append(
            utime.ticks_diff(thisComeInTime, self.start)
        )  # This is the time difference between the two changes of the signal
        self.start = thisComeInTime
    ...
    def my_irread(self):
        ...
        if utime.ticks_diff(utime.ticks_us(), self.start) > 100000 and self.index > 0:
